<table border="1" style="border-collapse: collapse; width: 100%; font-family: Arial, sans-serif; font-size: 14px;">
  <thead>
    <tr>
      ...
      <th style="padding: 10px; text-align: center;"></th>
      <th style="padding: 10px; text-align: center;"></th>
      <th style="padding: 10px; text-align: center;" colspan="2">Ye Htet Kyaw</th>
      <th style="padding: 10px; text-align: center;" colspan="2">Ibrahim Abdelmalek</th>
      <th style="padding: 10px; text-align: center;" colspan="2">Dodly Forbi</th>
      <th style="padding: 10px; text-align: center;" colspan="2">Gabriel Tchakunte Tchouteng</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="padding: 10px; text-align: center;">Number</td>
      <td style="padding: 10px; text-align: center;">Task</td>
      <td style="padding: 10px; text-align: center;">Short Summary</td>
      <td style="padding: 10px; text-align: center;">To Do <br>(Dead line)</td>
      <td style="padding: 10px; text-align: center;">Finishing Date</td>
      <td style="padding: 10px; text-align: center;">To Do <br>(Dead line)</td>
      <td style="padding: 10px; text-align: center;">Finishing Date</td>
      <td style="padding: 10px; text-align: center;">To Do <br>(Dead line)</td>
      <td style="padding: 10px; text-align: center;">Finishing Date</td>
    ...
    <tr>
      ...
      <td style="padding: 10px; text-align: center;">Holder designs</td>
      ...
      <td style="padding: 10px; text-align: center;">6 May</td>
      <td style="padding: 10px; text-align: center;">Ultrasonic Holder<br>(7 May)</td>
      <td style="padding: 10px; text-align: center;">6 May</td>
    </tr>
    <tr>
      ...
      <td style="padding: 10px; text-align: center;">24 May</td>
      <td style="padding: 10px; text-align: center;">State Machine + Use case Diagram<br>(24 May)</td>
      <td style="padding: 10px; text-align: center;">24 May</td>
      <td style="padding: 10px; text-align: center;">Block Definition + Internal Block Diagram<br>(24 May)</td>
      <td style="padding: 10px; text-align: center;">24 May</td>
    </tr>
    <tr>
